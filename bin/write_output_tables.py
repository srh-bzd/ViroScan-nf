...
if __name__ == "__main__":
    ...
    parser.add_argument('output_file', help="Output file were the table of percent mapped reads will be written;", type=argparse.FileType('w'))
    parser.add_argument('threshold', help="Minimum percent mapped reads to report;",type=float)
    parser.add_argument('--output_counts', '-c', required=False, help="Output log file with total count of reads aligned;", type=argparse.FileType('w'), default=sys.stdout)
